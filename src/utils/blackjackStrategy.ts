...
export const DEVIATIONS: Deviation[] = [
  ...
  { kind: 'pair', total: 9,  dealerIdx: 9, threshold:  5, action: 'P', note: '10,10 vs 10 split' },
  { kind: 'hard', total: 12, dealerIdx: 2, threshold:  3, action: 'S', note: '12 vs 3' },
  { kind: 'hard', total: 12, dealerIdx: 1, threshold:  2, action: 'S', note: '12 vs 2' },
