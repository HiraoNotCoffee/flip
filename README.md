...
**リンクとコードの2つ**で共有する。リンクは「どのメッセージか」を指すだけで、
中身を開く鍵にはならない。
...
- コードは口頭で伝える想定（同じ卓にいるなら言うだけで済む）

そのかわり、**収支を Discord のチャンネルで読むことはできなくなった**。
「チャンネルを見れば分かる」と「承認した人だけが見られる」は両立しないため。
